...
function copyrightInicio() {
  
  var parrafoCopyright = document.getElementById('copyright-helpU');
  var meses = new Array("Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre");
  var diasSemana = new Array(" Domingo", " Lunes", " Martes", " Miércoles", " Jueves", " Viernes", " Sábado");
  var f = new Date();
  var mensajeCopyright = "© helpU - Todos los derechos reservados " + diasSemana[f.getDay()] + ", " + f.getDate() + " de " + meses[f.getMonth()] + " de " + f.getFullYear();
  var mensajeATexto = mensajeCopyright.toString();

  parrafoCopyright.innerText = mensajeATexto;
}
